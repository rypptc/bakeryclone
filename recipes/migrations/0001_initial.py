    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_recipe_relationship', to='home.person')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
